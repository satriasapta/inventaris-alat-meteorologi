                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($alat as $a) : ?>
                                        <tr>
                                            ...
                                            <td><label><input type="radio" value="1" name="id_operasi[<?= $index; ?>]" class="i-checks" required> <i></i></label></td>
                                            <td><label><input type="radio" value="2" name="id_operasi[<?= $index; ?>]" class="i-checks" required> <i></i></label></td>
